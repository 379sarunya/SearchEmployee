                ...
                <>
                     {employees.data.length > 0 && (
                            <>    
                                ...
                                {/* ฟอร์มค้นหาพนักงาน */}
                                <form onSubmit={handleSearch} style={{ display: 'flex', justifyContent: 'center', marginBottom: '50px' }}> 
                                    <input
                                        type="text"
                                        value={search}
                                        ...
                                        style={{
                                            marginRight: '10px', padding: '10px', borderRadius: '5px', border: '1px solid #ddd', width: '250px'
                                        }}
                                    />
                                    <button 
                                        type="submit" 
                                        style={{
                                            padding: '10px 20px', borderRadius: '5px', border: 'none', backgroundColor: '#007bff', color: '#fff', cursor: 'pointer'
                                        }}
                                    >
                                        Search
                                    </button>
                        ...
                        <div style={{ width: '100%', overflowX: 'auto' }}>
                            <div style={{ maxWidth: '1300px', margin: '0 auto', padding: '20px', border: '1px solid #ddd', borderRadius: '8px', boxShadow: '0 2px 5px rgba(0,0,0,0.1)' }}>
                                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                                    <thead>
                                        <tr>
                                            <th onClick={() => requestSort('emp_no')} style={{ borderBottom: '1px solid #ddd', padding: '10px 20px', cursor: 'pointer', textAlign: 'center' }}>ID {getArrow('emp_no')}</th>
